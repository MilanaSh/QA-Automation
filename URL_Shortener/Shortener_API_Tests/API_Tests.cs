...
namespace Shortener_API_Tests
{
    public class API_Tests
    {
        ...
        public void Test_ListUrls_CheckFirst()
        {
            ...
            var allUrls = JsonSerializer.Deserialize<List<URLS>>(response.Content);
        ...
        public void Test_SearchUrlsByShort_CheckFirst_ValidData()
        {
            ...
            var response = this.client.Execute(request);
            var allUrls = JsonSerializer.Deserialize<URLS>(response.Content);
        ...
        public void Test_CreateNewShort_ValidData()
        {
            ...
            var allUrls = JsonSerializer.Deserialize<List<URLS>>(updatedUrls.Content);
        ...
        public void Test_VisitUrl_IncreaseVisits_ValidData()
        {
            ...
            var websiteProp = JsonSerializer.Deserialize<URLS>(response1.Content);
            ...
            var updated = JsonSerializer.Deserialize<URLS>(response.Content);
